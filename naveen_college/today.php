...
<body id="attmain">
    ...
    <h1 id="displayh1">STUDENT ALL TODAY ATTENDANCE DETAILS</h1>
    <table id="atttable">
        <tr>
        <td>std_id</td>
        <td>std_roll_no</td>
    ...
    <?php
    $sql = "SELECT std_id,std_roll_no,std_name,std_date,std_attendance1,std_attendance2,std_attendance3,std_attendance4,std_attendance5,(std_attendance1+std_attendance2+std_attendance3+std_attendance4+std_attendance5) as total from stdattendance where std_date = date_format(curdate(),'%Y-%m-%d');";
